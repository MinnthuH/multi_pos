                        ...
                        <form method="post" action="{{ route('supplier.update', $suppliers->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <x-text-input id="name" name="name" type="text"
                                    class="tw-mt-1 tw-block tw-w-full" :value="old('name', $suppliers->name)" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <x-text-input id="email" name="email" type="email"
                                    class="tw-mt-1 tw-block tw-w-full" :value="old('email', $suppliers->email)" />
                            </div>

                            <div class="form-group">
                                <x-input-label for="phone" value="Phone" />
                                <x-text-input id="phone" name="phone" type="text"
                                    class="tw-mt-1 tw-block tw-w-full" :value="old('phone', $suppliers->phone)" />
                            </div>

                            <div class="form-group">
                                <x-input-label for="url" value="Url" />
                                <x-text-input id="url" name="url" type="text"
                                    class="tw-mt-1 tw-block tw-w-full" :value="old('url', $suppliers->url)" />
                            </div>

                            <div class="form-group">
                                <x-input-label for="city" value="City" />
                                <x-text-input id="city" name="city" type="text"
                                    class="tw-mt-1 tw-block tw-w-full" :value="old('city', $suppliers->city)" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <x-text-input id="region" name="region" type="text"
                                    class="tw-mt-1 tw-block tw-w-full" :value="old('region', $suppliers->region)" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <x-text-input id="country" name="country" type="text"
                                    class="tw-mt-1 tw-block tw-w-full" :value="old('country', $suppliers->country)" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <x-textarea id="description" name="description"
                                    rows="3">{{ old('description', $suppliers->description) }}</x-textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <x-text-input id="supplier_code" name="supplier_code" type="text"
                                    class="tw-mt-1 tw-block tw-w-full" :value="old('supplier_code', $suppliers->supplier_code)" />
                            </div>

                            <div class="form-group">
                                <x-input-label for="opening_balance" value="Opening Balance" />
                                <x-text-input id="opening_balance" name="opening_balance" type="text"
                                    class="tw-mt-1 tw-block tw-w-full" :value="old('opening_balance', $suppliers->opening_balance)" />
                            </div>

                            <div class="form-group">
                                <x-input-label for="balance" value="Balance" />
                                <x-text-input id="balance" name="balance" type="text"
                                    class="tw-mt-1 tw-block tw-w-full" :value="old('balance', $suppliers->balance)" />
                            </div>
